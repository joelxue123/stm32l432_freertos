...
TaskStatus_t TaskStatusArray_[12];

void vApplicationIdleHook( void )
{

  system_stats_.min_heap_space = xPortGetMinimumEverFreeHeapSize();
  system_stats_.min_stack_space_thread0 =  uxTaskGetStackHighWaterMark(defaultTaskHandle) * sizeof(StackType_t);
  system_stats_.min_stack_space_thread1 =  uxTaskGetStackHighWaterMark(myTask02Handle) * sizeof(StackType_t);
  system_stats_.min_stack_space_thread2 =  uxTaskGetStackHighWaterMark(myTask03Handle) * sizeof(StackType_t);
...
/**
 ...
 static int is_debug_thread_space = 0;
  static int  is_debug_thread_infor = 1;
  ...
  for(;;)
  {
   ...
   //   sprintf(buffer, "thread0  is %d. thread1  is %d thread2  is %d", system_stats_.min_stack_space_thread0,system_stats_.min_stack_space_thread1,system_stats_.min_stack_space_thread2);
    ...
    if(is_debug_thread_infor)
    {
      ...
      uxTaskGetSystemState(TaskStatusArray_, uxArraySize, NULL);
